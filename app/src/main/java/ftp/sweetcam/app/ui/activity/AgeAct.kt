...
class AgeAct : BaseActivity(R.layout.activity_age) {
    ...
    override fun onConvert() {
        ...
        ageMainIv.loadWith(Constant.imageUrl)
        createItem()
    ...
    private fun createItem() {
        ...
        img1.setBackgroundResource(R.mipmap.icon_age_11)
        option.addView(img1)
        ...
        img2.setBackgroundResource(R.mipmap.icon_age_21)
        option.addView(img2)
        ...
        img3.setBackgroundResource(R.mipmap.icon_age_31)
        option.addView(img3)
        ...
        img4.setBackgroundResource(R.mipmap.icon_age_41)
        option.addView(img4)
    }
}